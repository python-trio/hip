...
Hip is made available under both the MIT License and Apache-2.0 License.
For more details, see `LICENSE <https://github.com/python-trio/hip/blob/master/LICENSE>`_.
